...
<html lang="en">
  ...
  <div class="row" style="align-items: center;">
        ...
        <ul class="nav justify-content-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="./comprarTicket.jsp" style="color: rgb(8, 190, 8); ">Comprar Tickets</a>
          </li>
          <li class="nav-item">
            <a class="nav-link btn-log-reg" href="login.jsp">Cerrar Sesión</a>
           </li>
        </ul>
      </div>
    </div>
...
<div class="row my-3">
  ...
  <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" style="background-color: rgb(58, 58, 58);">
   ...
   <p class="text-justify" style="color: white;">Buenos Aires es la provincia y la localidad mas grande del estado de Argentina, en los Estados Unidos, Honolulu es la mas sureÃ±a 
